...
Common_data = RNA_data_scaled[np.intersect1d(Starmap_data_scaled.columns,RNA_data_scaled.columns)]
#genes_to_impute = ["Tesc","Pvrl3","Sox10","Grm2","Tcrb"]
genes_to_impute = np.setdiff1d(RNA_data.columns,Starmap_data.columns)
...
FISH_exp_t = Starmap_data_scaled[Common_data.columns].dot(S)
