...
plt.boxplot([Starmap_before, Ziesel_before, AllenVISp_before,AllenSSp_before,MERFISH_before],
            positions = [1,4,7,10,13],boxprops=dict(color='red'),
            capprops=dict(color='red'),whiskerprops=dict(color='red'),flierprops=dict(color='red', markeredgecolor='red'),
            medianprops=dict(color='red'))
plt.boxplot([Starmap_after, Ziesel_after, AllenVISp_after,AllenSSp_after,MERFISH_after],
            positions = [2,5,8,11,14],boxprops=dict(color='blue'),
            capprops=dict(color='blue'),whiskerprops=dict(color='blue'),flierprops=dict(color='blue', markeredgecolor='blue'),
            medianprops=dict(color='blue'))
plt.xticks((1.5,4.5,7.5,10.5,13.5),('STARmap_AllenVISp','osmFISH_Ziesel','osmFISH_AllenVISp',
           'osmFISH_AllenSSp','MERFISH_Moffit'),size=10)
plt.yticks(size=8)
...
plt.style.use('ggplot')
plt.figure(figsize=(8, 4))
plt.boxplot([Starmap_before, Ziesel_before,MERFISH_before],
            positions = [1,4,7],boxprops=dict(color='red'),
            capprops=dict(color='red'),whiskerprops=dict(color='red'),flierprops=dict(color='red', markeredgecolor='red'),
            medianprops=dict(color='red'))
plt.boxplot([Starmap_after, Ziesel_after,MERFISH_after],
            positions = [2,5,8],boxprops=dict(color='blue'),
            capprops=dict(color='blue'),whiskerprops=dict(color='blue'),flierprops=dict(color='blue', markeredgecolor='blue'),
            medianprops=dict(color='blue'))
y = Starmap_before
...
plt.xticks((1.5,4.5,7.5),('STARmap_AllenVISp','osmFISH_Ziesel'
                          ,'MERFISH_Moffit'),size=10)
plt.yticks(size=8)
plt.gca().set_ylim([-0.5,1.1])
plt.ylabel('Cosine similarity',size=12)
colors = ['red', 'blue']
...
plt.style.use('ggplot')
plt.figure(figsize=(8, 4))
parts1 = plt.violinplot([Starmap_before, Ziesel_before,MERFISH_before],
            positions = [1,4,7],showextrema=False,showmedians=True)
for pc in parts1['bodies']:
    pc.set_facecolor('red')
    pc.set_edgecolor('black')
    pc.set_alpha(1)

plt.violinplot([Starmap_after, Ziesel_after,MERFISH_after],
            positions = [2,5,8],showextrema=False)
plt.xticks((1.5,4.5,7.5),('STARmap_AllenVISp','osmFISH_Ziesel'
                          ,'MERFISH_Moffit'),size=10)
plt.yticks(size=8)
plt.gca().set_ylim([-0.5,1.1])
